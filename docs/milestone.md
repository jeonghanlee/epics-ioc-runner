...
| --- | --- | --- | --- | --- | --- |
| M1 | 1.2.1 | (#104) Verify-exit contract: setup exits 1 on VERIFY_FAIL>0; verify helpers abort-proof (missing path counts a FAIL, never kills the run) | Review follow-up | Open | R5-F1/R7-F1/R9-F1 (three-lane convergence C1), R7-F12/R9-F3. Golden harness exit-code expectations confirmed before landing (R7 Q3). |
