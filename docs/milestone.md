...
docs only, external review accepted, `Closes #79` on master merge). Next entry
point: #80 (crash-detection comment, CI-3), a 1.1.1 comment-only cleanup from
the 2026-06-04 coherence sweep. Version
...
**Tally:** Done 8 · Open 8 · Not started 0 · In progress 0 · Blocked 0
