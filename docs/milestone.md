...
GitHub closed). Next entry point: #75. Version is
`1.1.1-dev` (`bin/ioc-runner:14`). Do not start 1.2.0 items unless the owner
reorders them. Two #74 follow-ups are deferred to separate issues: a `_setup`
suite-wide procServ mock, and the `-x`/`-f` executable-directory resolver
policy common to con and procServ.
...
**Tally:** Done 6 · Open 5 · Not started 1 · In progress 0 · Blocked 0
