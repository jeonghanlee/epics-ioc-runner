...
- Observed 2026-09-02: issue #150 is closed after M14 T1-T3 passed on corrected
  ...
  the separate Release Verification 2 rerun remained required.
- Observed 2026-09-02 13:38 PDT: Release Verification 2 passed as a separate
  complete gate at corrected product commit
  `63c7f828f1145bda4036d9f4641ac6f02d647cd6`. Full setup passed 9/9 checks on
  Debian 13 and 12/12 checks on Rocky 8. Each fresh consumer passed all six
  suite blocks and 897 checks; Debian reported five reviewed NA results and
  Rocky reported twelve. No Fail, Skip, or Script Error result occurred, the
...
- Observed 2026-09-02 23:51 PDT: Release Verification 4 passed on the same
  consumers at exact D21 candidate commit
  `6aafbb8f8d5d80ba387fefe32234e78f4289c02b`. cloud-provision commit
  `35c859b17830e976cc09ad95f29051cfd469e61d` and ansible-provision commit
  `e3fbae5621213b52febbcd79d765938d6dc9feba` remained clean. Both `nfs_sim`
  operator recaps reported no unreachable or failed host, both NFS4 mounts
  reproduced `root_squash`, and both NFS-backed checkouts remained clean at
  the candidate commit. All three deployment entry points completed without
  a password prompt or error, advanced the installed-file timestamp, retained
  version `1.3.0 (6aafbb8)`, and left each host's configuration fingerprint
...
| Platform | Operator Recap | NFS4 root_squash | Runner Setup | `make install` | `make setup` | Configuration | Candidate |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Debian 13 | ok=10, unreachable=0, failed=0 | Reproduced | 2/2 | 2/2 | 9/9 | Baseline matched after every entry | `1.3.0 (6aafbb8)` |
| Rocky 8 | ok=11, unreachable=0, failed=0 | Reproduced | 3/3 | 3/3 | 12/12 | Baseline matched after every entry | `1.3.0 (6aafbb8)` |

The control, cloud-provision, and ansible-provision checkouts were clean at
commits `6aafbb8f8d5d80ba387fefe32234e78f4289c02b`,
`35c859b17830e976cc09ad95f29051cfd469e61d`, and
`e3fbae5621213b52febbcd79d765938d6dc9feba`, respectively. The complete
