...
| [0004](0004-severity-marker-corroboration.md) | Severity-Marker Corroboration | Accepted (2026-09-18) | Which tokens the post-init corroboration scan matches (#153): case-sensitive framework severity markers (`ERROR`, ` ERR `/` CRIT `, `sevr=major\|fatal`) plus the case-insensitive message phrases; English error vocabulary excluded from the built-in set, per the 33-module emission survey and the real healthy-log measurement. |
