...
| `error-handling.S33.case-insensitive-error-upper` | `replace-and-move` | `source-regression.S20.case-insensitive-error-upper` (renamed `severity-error-upper-word`, D6/ADR 0004) | `source-regression` | `REQUIRED` | `direct-inspection` | Pin case-insensitive base-regex membership without claiming runtime behavior. |
| `error-handling.S33.case-insensitive-error-title` | `replace-and-move` | `source-regression.S20.case-insensitive-error-title` (renamed `prose-error-title-benign`, D6/ADR 0004) | `source-regression` | `REQUIRED` | `direct-inspection` | Pin case-insensitive base-regex membership without claiming runtime behavior. |
| `error-handling.S33.case-insensitive-error-lower` | `replace-and-move` | `source-regression.S20.case-insensitive-error-lower` (renamed `prose-error-lower-benign`, D6/ADR 0004) | `source-regression` | `REQUIRED` | `direct-inspection` | Pin case-insensitive base-regex membership without claiming runtime behavior. |
...
| `error-handling.S33.subset-error-is-ambiguous` | `move` | `source-regression.S20.subset-error-is-ambiguous` (renamed `subset-error-word-is-severity`, D6/ADR 0004) | `source-regression` | `REQUIRED` | `direct-inspection` | Pin ambiguous-subset source membership. |
