...
The S03 sudoers syntax check, the S04 logrotate syntax check, and the two S06
authorization probes use `real-path`. All other rows use
`direct-inspection` against the actual installed host state.
