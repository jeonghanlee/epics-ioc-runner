...
| source-regression | test-source-regression.bash | system | source | source-regression | SOURCE_REGRESSION_INVENTORY.md | 93 |
...
- Human and machine output use the same ledger and the same 512 identities.
...
their sum is 512, every source assertion and conditional result branch has one
