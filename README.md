...
## Key Highlights
* **No Python or Framework Runtime**: Built on Bash 4.3+ and native `systemd`. Runtime depends on `procServ`, `con`, `lsof`, `ss`, and `awk`; no Python interpreter or application framework is required.
